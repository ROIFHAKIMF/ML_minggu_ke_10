...
plt.plot(df_filtered.index, df_filtered['Close'], label='Harga snp500', color='orange', linewidth=2)
...
plt.title('Harga SNP500 + EMA 13, 21, 100, 200 (2018 - 2024)')
plt.xlabel('Tahun')
plt.ylabel('Harga (USD)')
plt.grid(True)
plt.legend()
plt.tight_layout()
plt.savefig("spx_chart.png")
plt.show()
